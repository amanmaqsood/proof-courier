...
- **P2 production cutover verified:** independent wallet, verifier, and showcase artifacts now serve the canonical public aliases. Owning routes and entry chunks return 200, peer role routes and chunks return 404, and the six-header matrix passes.
...
- **P2 browser rerun passed:** the post-cutover public journey completed request negotiation, visible consent, one atomic export, proof verification, and the human-only final boundary across the canonical wallet and verifier origins.
