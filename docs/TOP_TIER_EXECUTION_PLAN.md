...
- **P2 protected candidates verified:** no-alias deployments from commit `9183e7a` pass their role-route, peer-route, entry-chunk, and six-header matrices. The canonical public aliases have not been moved, so this is candidate evidence rather than production cutover proof.
